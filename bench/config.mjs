...
export const config = new akasha.Configuration();
...
config
   ...
   .addAssetsDir({
    ...
    .addDocumentsDir({ src: '../docs100-01', dest: 'docs01' })
    .addDocumentsDir({ src: '../docs100-02', dest: 'docs02' })
    .addDocumentsDir({ src: '../docs100-03', dest: 'docs03' })
    .addDocumentsDir({ src: '../docs100-04', dest: 'docs04' })
    .addDocumentsDir({ src: '../docs100-05', dest: 'docs05' })
    .addDocumentsDir({ src: '../docs100-06', dest: 'docs06' })
    .addDocumentsDir({ src: '../docs100-07', dest: 'docs07' })
    .addDocumentsDir({ src: '../docs100-08', dest: 'docs08' })
    .addDocumentsDir({ src: '../docs100-09', dest: 'docs09' })
    .addDocumentsDir({ src: '../docs100-10', dest: 'docs10' })
