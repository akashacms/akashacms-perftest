...
config
   ...
   .addAssetsDir({
    ...
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs01' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs02' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs03' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs04' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs05' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs06' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs07' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs08' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs09' })
    .addDocumentsDir({ src: 'docs100-handlebars', dest: 'docs10' })
