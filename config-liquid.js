...
config
   ...
   .addAssetsDir({
    ...
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs01' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs02' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs03' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs04' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs05' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs06' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs07' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs08' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs09' })
    .addDocumentsDir({ src: 'docs100-liquid', dest: 'docs10' })
